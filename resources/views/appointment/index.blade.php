                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="bg-light rounded d-flex align-items-center p-5 mb-4">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">+998 93 588 9114</h5>
                        </div>
                    </div>
                    <div class="bg-light rounded d-flex align-items-center p-5">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">jalilovquvonchbek4@gmail.com</h5>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select border-0" style="height: 55px;" name="doctor">
                                        ...
                                        <option value="{{ $doctor->id }}">{{ $doctor->first_name }} {{ $doctor->last_name}} ({{ $doctor->desease->name}})</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 col-sm-6">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control border-0" name="description" rows="5" placeholder="Describe your problem"></textarea>
                                </div>
                                <div class="col-12">
